...
/**
 * https://github.com/googlesamples/android-architecture-components/blob/master/PagingWithNetworkSample/app/src/main/java/android/arch/paging/PagingRequestHelper.java
 */
public class PagingRequestHelper {
    ...
    public boolean retryAllFailed() {
        ...
        synchronized (mLock) {
            for (int i = 0, len = RequestType.values().length; i < len; i++) {
        ...
        class Callback {
            ...
            public final void recordSuccess() {
                if (mCalled.compareAndSet(false, true)) {
                    ...
                    throw new IllegalStateException("already called recordSuccess");
                }
            }
            ...
            public final void recordFailure(@NonNull Throwable throwable) {
                if (mCalled.compareAndSet(false, true)) {
                    ...
                    throw new IllegalStateException("already called recordFailure");
                }
            }
        }
    }
    ...
    public static final class StatusReport {
        ...
        public boolean equals(Object o) {
            ...
            return initial == that.initial &&
                    before == that.before &&
                    after == that.after &&
                    Arrays.equals(mErrors, that.mErrors);
        }
    ...
    public enum RequestType {
         ...
         * a {@link BoundaryCallback BoundaryCallback}.
         */
        INITIAL,

        /**
         * Corresponds to the {@code loadBefore} calls in {@link DataSource} or {@code onItemAtFrontLoaded} in
         * {@link BoundaryCallback BoundaryCallback}.
         */
        BEFORE,

        /**
         * Corresponds to the {@code loadAfter} calls in {@link DataSource} or {@code onItemAtEndLoaded} in
         * {@link BoundaryCallback BoundaryCallback}.
         */
        AFTER,
    }
